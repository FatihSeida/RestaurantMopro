package com.restaurant.fatih.auth;
...
import com.restaurant.fatih.R;
import com.restaurant.fatih.model.Login;
import com.restaurant.fatih.model.RegisterResponse;
import com.restaurant.fatih.utils.DialogUtils;

import static com.restaurant.fatih.data.Constans.REGISTER;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void register(){
        ...
        AndroidNetworking.post(REGISTER)
                ...
                .build().getAsObject(RegisterResponse.class, new ParsedRequestListener() {
            @Override
